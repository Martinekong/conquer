export const destinations = [
  {
    ...
    continent: 'europe',
    description:
      'A land of dramatic fjords, snowy mountains, and the midnight sun. Perfect for skiing, hiking, and northern lights adventures.',
    content:
    ...
    funFacts: [
      ...
      'Norwegians invented modern skiing over 4,000 years ago.',
      'The country consistently ranks among the happiest in the world.',
      'Norway has a free public higher education system—even for foreigners.',
    ],
  },
  {
    country: 'nepal',
    continent: 'asia',
    description:
      'Home to the Himalayas, Nepal offers breathtaking trekking routes, rich culture, and spiritual experiences.',
    content:
    ...
    funFacts: [
      ...
      "Mount Everest is called 'Sagarmatha' in Nepali.",
      'The living goddess tradition—Kumari—is still practiced in Kathmandu.',
  ...
  },
  {
    ...
    continent: 'asia',
    description:
      'An island paradise with stunning beaches, coral reefs, rainforests, and ancient temples waiting to be explored.',
    content:
    ...
    funFacts: [
      ...
      'Bali has its own distinct culture and language.',
      'Indonesia is home to Komodo dragons—the world’s largest lizards.',
  ...
  },
  {
    ...
    funFacts: [
      ...
      'The Nazca Lines are giant geoglyphs best viewed from the air.',
      'Peru has three distinct climate zones: coastal desert, mountains, and rainforest.',
    ],
  },
  {
    country: 'vietnam',
    continent: 'asia',
    description:
      'Vietnam offers dramatic landscapes, vibrant cities, rich history, and peaceful river journeys like in Ninh Binh.',
    content:
    ...
    funFacts: [
      ...
      'Halong Bay is a UNESCO World Heritage Site with over 1,600 limestone islands.',
      'Vietnamese coffee is among the strongest and most unique in the world.',
      'The country is one of the world’s largest exporters of cashews and black pepper.',
    ],
  },
  {
    country: 'australia',
    continent: 'oceania',
    description:
      'A playground for adventure seekers. Surf golden beaches, dive the Great Barrier Reef, or explore rugged outback.',
    content:
    ...
    funFacts: [
      ...
      'It’s the only continent covered by a single country.',
      'The Outback takes up about 70% of the landmass.',
      'Australia has over 10,000 beaches—visit one a day for 27 years!',
    ],
  },
  {
    country: 'iceland',
    continent: 'europe',
    description:
      'An island of fire and ice with volcanic landscapes, glaciers, hot springs, and epic waterfalls.',
    content:
    ...
    funFacts: [
      ...
      'You can see the northern lights 8 months of the year.',
      'Most Icelanders believe in elves or hidden people.',
  ...
  },
  {
    ...
    funFacts: [
      ...
      'The Masai Mara hosts the Great Migration of over 1.5 million animals annually.',
      'Kenya has over 60 national parks and reserves.',
  ...
  },
  {
    ...
    funFacts: [
      ...
      'You can find polar bears roaming freely in some northern towns.',
    ],
  },
];
